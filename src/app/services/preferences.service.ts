...
export const DEP_PA: string = "Good [MORNING] ladies and gentlemen.\n\n" +
  ...
  "I would like to welcome you on board this Boeing 777, flight [NUMBER] to [DESTINATION], [DESTINATION_NAME].\n\n" +
  ...
  "Before we begin our descent into [DESTINATION], [DESTINATION_NAME], I’ll update you with the latest weather " +
...
export const ARR_PA: string = "Good [MORNING] ladies and gentlemen. This is your Captain speaking.\n\n" +
  ...
  "We’ll be starting our descent into [DESTINATION], [DESTINATION_NAME] shortly, and should be landing in [TIME_TO_GO] minutes, approximately [ETA_LOCAL].\n\n" +
  "It’s a [WEATHER] day today, with a temperature of [TEMPC] Celsius / [TEMPF] Fahrenheit.\n\n" +
  "The local time now is [TIME_NOW].\n\n" +
  "On behalf of all the crew, we wish you a very pleasant stay in [DESTINATION], [DESTINATION_NAME], or a smooth onward journey.\n\n" +
